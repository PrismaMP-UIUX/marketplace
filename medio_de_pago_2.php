		...
		<div class="modal-content">
			...
			<div class="row">
				<div class="col s6 m6 l6 offset-s3 offset-m3 offset-l3">
					<p class="mg-t-20">1. Ingresá a tu home banking.</p>
					<p class="mg-t-20">2. Revisá los últimos movimientos de la tarjeta.</p>
					<p class="mg-t-20">3. Ingresá acá el importe debitado y te devolvemos el dinero.</p>
					<div class="pd-b-20">
			            <span>$</span>
			            <input type="text" class="max-70 pd-l-10mg-b-0">
			        </div>
			        <a class="btn blue white-text modal-action modal-close waves-effect waves-light">Validar <i class="material-icons right">check</i> </a>
			    </div>
			</div>
		</div>
	</div>
