                  ...
                  <div class="col s12">
                    <div class="card-tabs mg-b-30">
                      <ul id="tabs-swipe-demo" class="tabs tabs-fixed-width">
                        ...
                        <li class="tab col s3"><a href="#test-swipe-2"><span class="hide-on-small-only">Por</span> Rubros</a></li>
                        <li class="tab col s3 active" ><a href="#test-swipe-3"><span class="hide-on-small-only">Pagos</span> Realizados</a></li>
                      </ul>
                    </div>
                        ...
                        <div class="row">
                          <div class="col s12 center-align">
                            <!-- Vista Rubros -->
                						...
                						<a href="#nuevopago" class="btn btn-two-lines blue modal-trigger mg-t-30">Hacer un Pago</a>
                					</div>
                        </div>
