                      ...
                      <li class="step">
                        ...
                        <div class="step-content">
                          <p class="grey-text text-darken-2">
                            Se agrego como medio de pago
                          </p>
                          <div class="pd-t-20 pd-b-20">
                            <input type="checkbox" class="filled-in" id="agregar-como-medio-pago"/>
                            <label for="agregar-como-medio-pago">Elegir como medio de pago favorito</label>
                          </div>
                          <button data-feedback="anyThing" class="btn blue waves-effect waves-white next-step">Continuar</button>
                        </div>
                      </li>
                    </ul>
                  </form>
